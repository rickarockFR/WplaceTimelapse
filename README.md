...
You will need to have [Python 3](https://www.python.org/downloads/) downloaded, along with the Pillow and ImageIO libraries. You can download the libraries by either running the "requirements.bat" file, or getting them manually by following [this tutorial](https://packaging.python.org/en/latest/tutorials/installing-packages/).
